...
<head>
    ...
    <title>Business Administration Collection</title>
</head>
                        ...
                        <div class="book-card-body">
                            <div class="card-content-container" style="height: 170px; border-radius: 5px">
                                ...
                                @if ($book->downloadable == 1 && $book->file_path)
                                    <a href="{{ route('file.download', $book->id) }}" class="btn btn-success download-btn mt-5">Download</a>
                                @endif
                            </div>
                        </div>
