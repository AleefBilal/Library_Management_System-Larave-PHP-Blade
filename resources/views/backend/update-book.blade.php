...
@section('body')
    ...
    @error('name')
        ...
        <input type="text" id="author" name="author_name" value="{{$book->author_name}}" required><br>
        <span class="text-danger">
    @error('author')
            {{$message}}
            @enderror
        ...
        <input type="date" id="date" name="published_date" value="{{$book->published_date}}" required><br>
        <span class="text-danger">
    @error('date')
            {{$message}}
            @enderror
        ...
        <textarea id="description" name="description" rows="2" cols="40">{{$book->description}}</textarea>
        <span class="text-danger">
            @error('description')
            {{$message}}
            @enderror
